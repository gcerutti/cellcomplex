...
#         from tissue.cellcomplex.mesh_oalab.widget.property_topomesh_panel import TopomeshControlPanel
...
#     def __call__(self):
#         # Load and instantiate graphical component that actually provide feature
#         from tissue.cellcomplex.mesh_oalab.widget.dataframe_panel import DataframeControlPanel
