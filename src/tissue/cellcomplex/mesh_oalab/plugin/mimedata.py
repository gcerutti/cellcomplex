...
class MeshFileCodecPlugin(QMimeCodecPlugin):
    ...
    def __call__(self):
        from tissue.cellcomplex.mesh_oalab.mimedata.codec import MeshFileCodec
...
class TopomeshCodecPlugin(QMimeCodecPlugin):
    ...
    def __call__(self):
        from tissue.cellcomplex.mesh_oalab.mimedata.codec import TopomeshCodec
...
class DataFrameFileCodecPlugin(QMimeCodecPlugin):
    ...
    def __call__(self):
        from tissue.cellcomplex.mesh_oalab.mimedata.codec import DataFrameFileCodec
