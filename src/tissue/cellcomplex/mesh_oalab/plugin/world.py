...
class TopomeshControl(WorldPlugin):
    ...
    def __call__(self):
        from tissue.cellcomplex.mesh_oalab.world.property_topomesh_handler import TopomeshHandler
...
class DataframeHandlerPlugin(WorldPlugin):
    ...
    def __call__(self):
        from tissue.cellcomplex.mesh_oalab.world.dataframe_handler import DataframeHandler
