...
from tissue.cellcomplex.property_topomesh import PropertyTopomesh
from tissue.cellcomplex.triangular_mesh import TriangularMesh
from tissue.cellcomplex.property_topomesh.property_topomesh_extraction import cell_topomesh
