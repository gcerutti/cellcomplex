...
from tissue.cellcomplex.property_topomesh.property_topomesh_creation import triangle_topomesh, quad_topomesh, poly_topomesh
from tissue.cellcomplex.property_topomesh.utils.delaunay_tools import delaunay_triangulation
from tissue.cellcomplex.property_topomesh.property_topomesh_creation import dual_topomesh
...
def sphere_topomesh(radius=1.0,center=np.zeros(3)):
    from tissue.container import array_dict
    from tissue.cellcomplex.property_topomesh.property_topomesh_optimization import topomesh_triangle_split
...
def vtk_ellipsoid_topomesh(ellipsoid_radius=50.0, ellipsoid_scales=[1,1,1], ellipsoid_axes=np.diag(np.ones(3)), ellipsoid_center=np.zeros(3)):
    ...
    """      
    import vtk
    from tissue.cellcomplex.property_topomesh.utils.image_tools import vtk_polydata_to_triangular_mesh
