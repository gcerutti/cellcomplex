...
from tissue.cellcomplex.property_topomesh.utils.matching_tools import kd_tree_match
...
def read_obj_property_topomesh(obj_filename, verbose=True):
    ...
    import re
    from tissue.cellcomplex.property_topomesh.utils.array_tools import array_unique
    from tissue.cellcomplex.property_topomesh.property_topomesh_creation import triangle_topomesh
