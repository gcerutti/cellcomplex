...
from tissue.container.array_dict import array_dict
from tissue.container.property_topomesh import PropertyTopomesh
from tissue.cellcomplex.property_topomesh.property_topomesh_analysis import *
# from tissue.cellcomplex.property_topomesh.utils.tissue_analysis_tools import cell_vertex_extraction
from tissue.cellcomplex.property_topomesh.utils.array_tools import array_unique
# from tissue.container.topomesh_algo import is_collapse_topo_allowed, collapse_edge
...
def property_topomesh_edge_flip_optimization(topomesh,omega_energies=dict([('regularization',0.15),('neighborhood',0.65)]),simulated_annealing=True,display=False,**kwargs):
    from tissue.cellcomplex.property_topomesh.utils.geometry_tools import triangle_geometric_features
