...
# -*- coding: utf-8 -*-
#
# Package (Undefined, u'cellcomplex') documentation build configuration file, created by
...
project = u'vplants.cellcomplex'
copyright = u'2015, vplants.cellcomplex'
...
htmlhelp_basename = 'cellcomplexdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'cellcomplex.tex',
     u'cellcomplex Documentation',
...
texinfo_documents = [
    ('index', 'cellcomplex',
     ...
     u'Guillaume Cerutti',
     'cellcomplex',
     'Package implementing data structures and algorithms for the manipulation of cellular complexes.',
     'Miscellaneous'),
]
